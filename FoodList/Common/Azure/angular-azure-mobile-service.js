...
angular.module('azure-mobile-service.module', [])
  .service('Azureservice', ['$window', '$q', 'AzureMobileServiceClient', function Azureservice($window, $q, AzureMobileServiceClient) {
    ...
    return {
        ...
        getTable: function(tableName, withFilterFn){
        ...
        */
        query: function(tableName, obj, withFilterFn){
            ...
            if (angular.isDefined(obj) && angular.isObject(obj)){
                ...
                data = this.getTable(tableName, withFilterFn).where(obj.criteria, obj.params);
                ...
                data = this.getTable(tableName, withFilterFn).where({});
            }
        ...
        getById: function (tableName, id, withFilterFn) {
            ...
            return wrapAzurePromiseWithAngularPromise(this.getTable(tableName, withFilterFn).lookup(id));
        }, 
        ...
        */
        ...
        read: function (tableName, parameters, withFilterFn) {
            ...
            return wrapAzurePromiseWithAngularPromise(this.getTable(tableName, withFilterFn).read(parameters));
        },
        ...
        */
        ...
        insert: function(tableName, obj, withFilterFn){
            ...
            return wrapAzurePromiseWithAngularPromise(this.getTable(tableName, withFilterFn).insert(obj));
        },
        ...
        */
        ...
        update: function(tableName, obj, withFilterFn){
            ...
            return wrapAzurePromiseWithAngularPromise(this.getTable(tableName, withFilterFn).update(obj));
        },
        ...
        */
        ...
        del: function(tableName, obj, withFilterFn){
            ...
            return wrapAzurePromiseWithAngularPromise(this.getTable(tableName, withFilterFn).del(obj));
        },
